...
cv2.imwrite(os.path.join(o_path, 'Gamma_7.jpg'), gammaImg)
        ...
        for label in unique_labels:
            if label != -1:  # Exclude noise points
                ...
                for simplex in hull.simplices:
                    plt.plot(cluster_points[simplex, 0], cluster_points[simplex, 1], color=color, lw=2) #lw how thick the line will be
...
# Example usage:
parcelate_and_draw(np.vstack((coordinates_array)), 'ZZZZ_5.png')
