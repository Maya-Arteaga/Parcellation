...
cv2.imwrite(os.path.join(o_path, 'Gamma_8.jpg'), gammaImg)
...
def parcelate_and_draw(coordinates, filename):
    ...
    clusterer_1 = hdbscan.HDBSCAN(min_cluster_size=500, min_samples=2)
    ...
    clusterer_3 = hdbscan.HDBSCAN(min_cluster_size=5000, min_samples=2)
...
# Example usage:
parcelate_and_draw(np.vstack((coordinates_array)), 'ZZZZ_clusterer1.png')
